      ...
      <div class="vux-popup-picker-container">
        <div class="vux-popup-picker-header">
          <flexbox>
            ...
            <flexbox-item class="vux-popup-picker-header-menu vux-popup-picker-header-menu-right" @click.native="onHide(true)">{{confirmText || '确定'}}</flexbox-item>
          </flexbox>
        </div>
        <div class="popup-picker-loading" v-if="data.length === 0">
          <loading2></loading2>
        </div>
        <picker
        :data="data"
