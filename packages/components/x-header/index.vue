<template>
  <div class="vux-header">
    <div class="vux-header-left">
      <a class="vux-header-back" href="javascript:;" v-show="leftOptions.showBack" :transition="transition" @click="onClickBack">{{leftOptions.backText}}</a>
    ...
    <div class="vux-header-right">
      <a class="vux-header-more" href="javascript:;" @click="$emit('on-click-more')" v-if="rightOptions.showMore"></a>
