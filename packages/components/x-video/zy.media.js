	...
	zyMedia.MediaPlayer = function (media, option) {
		...
		if (t.options.nativeControls || zyMedia.features.isVendorControls) {
			...
			if (detectType(t.media, t.options, src)) {
				...
				var container = t.media.parentNode;
				container.innerHTML = '<div class="zy_wrap"></div><div class="zy_error">视频无法播放</div>';
				container.querySelector('.zy_wrap').appendChild(t.media);
				// t.media.parentNode.innerHTML = appendTo('<p>视频无法播放</p>')
